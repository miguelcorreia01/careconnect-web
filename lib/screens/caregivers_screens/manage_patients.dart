...
class _PatientListScreenState extends State<PatientListScreen> {
  ...
  Future<void> fetchPatients() async {
    ...
    final patientIds =
        relationSnapshot.docs.map((doc) => doc['patient_id']).toList();
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Enter the email of the older adult you want to add to your care list.',
                                    ...
                                    : () async {
                                      ...
                                      if (existingRelation.docs.isNotEmpty) {
                                        setModalState(() {
                                          isLoading = false;
                                          errorText =
                                              'This older adult is already linked to you.';
                                        });
                                        return;
                                      }
